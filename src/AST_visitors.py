...
class SVGRendererVisitor(Visitor) :
    ...
    def visitGroupedPar(self, grouped_expr):
        grouped_expr.expr.accept(self)
        #grouped_expr.svg = "<text x=\"0\" y=\"0\" font-size=\"1\" transform=\"translate({}, {}) #scale(1,{})\">(</text>".format(grouped_expr.x, grouped_expr.y (TODO en realidad se ajusta de otra manera que hay que ver), #grouped_expr.expr.h1+grouped_expr.expr.h1)
        #grouped_expr.svg += grouped_expr.expr.svg
        #grouped_expr.svg += "<text x=\"0\" y=\"0\" font-size=\"1\" transform=\"translate({}, {}) #scale(1,{})\">)</text>".format(grouped_expr.x + grouped_expr.a, grouped_expr.y, #grouped_expr.expr.h1+grouped_expr.expr.h1)
