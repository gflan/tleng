...
\section{Ejemplos}
    \subsection{Expresiones válidas del lenguaje}
        \begin{enumerate}
            \item \textbf{\textt{2+(\{\{(\{C/B\})\}/C\})}} 
            
            \underline{Output}:
            \begin{center}                \includegraphics[width=3cm,keepaspectratio]{imagenes/Ej1.png}
            \end{center}
            ...
            \item
            \textbf{\textt{(\{(A/B)(A/B)\}\^{}\{((A/B)(A/B)\_{}\{(A\_{}B)\})\})(A\_{}\{B\^{}\{B\^{}\{B\}\}\})}}
            
            \underline{Output}:
            \begin{center}                \includegraphics[width=8.5cm,keepaspectratio]{imagenes/Ej2.png}
            \end{center}
            ...
            \item
            \textbf{(Ax+B)\^{}\{A\_{}B\}(A)\_{}\{A\^{}A\}}} 
            
            \underline{Output}:
            \begin{center}                \includegraphics[width=5cm,keepaspectratio]{imagenes/Ej3.png}
            \end{center}
            ...
            \item
            \textbf{\textt{\{a\^{}2\_{}1+a\^{}2\_{}2+...+a\^{}2\_{}n\}/\{||(a\_{}1,...,a\_{}n)||\}}} 
            ...
            \item
            \textbf{\textt{\{\{A\^{}\{A\^{}\{A\^{}\{A\}\}\}\_{}n\}/\{B\^{}\{B\^{}\{B\}\}\_{}m\}\}+A+B}} 
    ...
    \subsection{Expresiones inválidas del lenguaje} 
        \begin{enumerate}
            \item
            \textbf{\textt{2+(\{\}}} (se abre un paréntesis que nunca se cierra).  
            
            \item
            \textbf{\textt{(A/B\})}} (se cierra una llave que nunca se abre).
            
            \item
            \textbf{\textt{A\^{}\{b+1\}\_{}}}  (subíndice vacío)  
            
            \item
            \textbf{\textt{A4\{\}\^{}}} (superíndice vacío)  
            
            \item (cadena vacía)
            
            \item
            \textbf{\textt{A\^{}A\^{}A}} (asociatividad a izquierda)
            
            \item
            \textbf{\textt{A\^{}B\_{}C\^{}D}}
        \end{enumerate}
    \end{subsection}
